...
static hal::Esp32Button        button1(PIN_BUTTON_1, BUTTON_ACTIVE_LOW, BUTTON_PULLUP_ACTIVE);
static hal::Esp32Button        button2(PIN_BUTTON_2, BUTTON_ACTIVE_LOW, BUTTON_PULLUP_ACTIVE);
